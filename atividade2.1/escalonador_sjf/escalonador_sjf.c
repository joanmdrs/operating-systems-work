...
/**
 * Simula a ocorréncia de uma interrupção para um processo que está bloqueado.
 *
...
/**
 * Gera um tempo aleatário para simular o tempo em que um processo passará na CPU.
 *
 ...
 *  aleatário menor que o QUANTUM, o que o levaria a mais eventos de E/S.
 *
